...
**🔍 [GraphQL Explorer (Endpoint)](https://hxtovivmtglemldjqjex.hasura.ap-south-1.nhost.run/v1/graphql)**
*(Note: To query the GraphQL endpoint directly, you will need to authenticate with a valid JWT token generated by logging into the live demo.)*
